  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="card">
          <div className="text-3xl font-medium">{stats.totalClients}</div>
          <div className="text-xs text-gray-500 mt-1">Clients actifs</div>
        </div>
        <div className="card">
          <div className="text-3xl font-medium">{formatMoney(stats.totalSolde)}</div>
          <div className="text-xs text-gray-500 mt-1">Solde global</div>
        </div>
        <div className="card">
          <div className="text-3xl font-medium">{stats.transactionsToday}</div>
          <div className="text-xs text-gray-500 mt-1">Transactions aujourd'hui</div>
        </div>
        <div className="card">
          <div className="text-3xl font-medium">{formatMoney(stats.collectesToday)}</div>
